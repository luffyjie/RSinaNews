...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        // 4.箭头图片
        UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"common_refresh_arrow"]];
...
- (void)endRefreshing
{
    double delayInSeconds = self.viewType == MJRefreshViewTypeFooter ? 0.5 : 0.5;
